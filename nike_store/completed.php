<?php
   ...
   //CHECK IF THE USER IS LOGGED IN
    ...
    if(isset($_POST['delete'])){
        ...
        header("location: product_buy_information.php?productID=".$productID."");
    }
...
<html>
   <head> 
        ...
        <title>Completed Shipment</title>
        ...
        <section class="homepage-section">
            <div class="cart-nav-bar">
                ...
                <div onclick="window.location='completed.php'" class="cart-nav-bar-items">
                    <span style="border-bottom: 2px solid black;">Completed</span>
                </div>
            </div>

            <div class="cart-container">
                <?php
                    $sql_checkCart = "SELECT * FROM cart WHERE uid='$uid' AND status='Order Received'";
                        ...
                        while($row = mysqli_fetch_array($res_checkCart)){
                            ...
                            echo "<div class=\"cart-container-flex-box\">";
                                ...
                                echo "<div class=\"cart-container-flex-box-right\">";
                                    ...
                                    <?php
                                    echo "<input type='submit' value='Buy More' id='mycart-btn' name='delete'></input>";
                                    //FOR INVI INPUT
