...
<html>
  ...
  <form id="contact" action="" method="post">
   <h3>&emsp;Contact Us</h3>
    <h4>&emsp;Whatever your comments are, we want to hear from you. Just fill out the feedback form below and we’ll respond as soon as possible.</h4>
    <div id="after_submit"></div>
<form id="contact_form" action="#" method="POST" enctype="multipart/form-data">
    <hr>
  <div class="row">
    &emsp;<label class="required" for="name">Name:</label><br />
    &emsp;<input id="name" class="input" name="name" type="text" value="" size="30" /><br />
    <span id="name_validation" class="error_message"></span>
</br>
  </div>
  <div class="row">
    &emsp;<label class="required" for="email">Email:</label><br />
    &emsp;<input id="email" class="input" name="email" type="text" value="" size="30" /><br />
    <span id="email_validation" class="error_message"></span>
  </div>
</br>
  <div class="row">
    &emsp;<label class="required" for="message">Message:</label><br />
    &emsp;<textarea id="message" class="input" name="message" rows="7" cols="30"></textarea><br />
    <span id="message_validation" class="error_message"></span>
  </div>
    
    &emsp;<input id="submit_button" type="submit" value="Send" />
</form>
