<?php
   ...
   //CHECK IF THE USER IS LOGGED IN
    ...
    if(isset($_POST['delete'])){
        ...
        window.alert('Your order has been canceled! Refund is in progress!')
        ...
        <section class="homepage-section">
            <div class="cart-nav-bar">
                ...
                <div onclick="window.location='toship.php'" class="cart-nav-bar-items">
                    <span style="border-bottom: 2px solid black;">To Ship</span>
                </div>
            ...
            <div class="cart-container">
                <?php
                    $sql_checkCart = "SELECT * FROM cart WHERE uid='$uid' AND status='paid'";
                        ...
                        while($row = mysqli_fetch_array($res_checkCart)){
                            ...
                            echo "<div class=\"cart-container-flex-box\">";
                                ...
                                echo "<div class=\"cart-container-flex-box-right\">";
                                    echo "<input type='submit' value='Cancel' id='mycart-btn' name='delete'></input>";
